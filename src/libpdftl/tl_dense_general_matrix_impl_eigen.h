...
public:
    ...
    // ---------------------------------------------------------------------------
public:
    explicit TlDenseGeneralMatrix_ImplEigen(const TlMatrixObject::index_type row = 0,
    ...
    TlDenseGeneralMatrix_ImplEigen(const TlDenseGeneralMatrix_ImplEigenFloat& rhs);
