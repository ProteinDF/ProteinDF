...
public:
    ...
    TlDenseGeneralMatrix_ImplScalapack dot(
        const TlDenseGeneralMatrix_ImplScalapack& rhs) const;
...
protected:
    ...
    // std::vector<TlMatrixObject::MatrixElement> getMatrixElementsInLocal()
    // const;
