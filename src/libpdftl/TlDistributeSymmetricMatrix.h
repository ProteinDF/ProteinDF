...
class TlDistributeSymmetricMatrix : public TlDistributeMatrix {
 ...
 public:
  ...
  explicit TlDistributeSymmetricMatrix(const TlDistributeVector& rhs, int dim);
 ...
 public:
  ...
  TlDistributeSymmetricMatrix& operator=(
  ...
  TlVector getPartialMatrix(int* pStartRow, int* pEndRow, int* pStartCol,
                            int* pEndCol) const;
  ...
  // const TlDistributeSymmetricMatrix& dot(const TlDistributeSymmetricMatrix&
  // X);
  ...
  TlDistributeMatrix choleskyFactorization(
      const double threshold = 1.0E-16) const;
  TlDistributeMatrix choleskyFactorization_mod(
      const double threshold = 1.0E-16) const;
  TlDistributeMatrix choleskyFactorization_mod2(
      const double threshold = 1.0E-16) const;
 ...
 public:
  ...
  // protected:
  //     virtual void saveElements(TlFileMatrix* pFileMatrix, const
 ...
 protected:
  ...
  friend TlDistributeMatrix operator*(const TlDistributeSymmetricMatrix& X,
  ...
  friend TlDistributeSymmetricMatrix operator*(
      double X, const TlDistributeSymmetricMatrix& Y);
  friend TlDistributeSymmetricMatrix operator*(
      const TlDistributeSymmetricMatrix& X, double Y);
