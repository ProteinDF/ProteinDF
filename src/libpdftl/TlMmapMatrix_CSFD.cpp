...
TlMmapMatrix_CSFD::TlMmapMatrix_CSFD(const std::string& filePath, const index_type row, const index_type col)
...
TlMatrixObject::size_type TlMmapMatrix_CSFD::getIndex(const index_type row, const index_type col) const
{
