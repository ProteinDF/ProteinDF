...
class TlDistributeMatrix : public TlMatrixObject {
 ...
 public:
  ...
  /// ベクトルからの変換コンストラクタ
  TlDistributeMatrix(const TlDistributeVector& rhs, const int row,
                     const int col);
 ...
 protected:
  ...
  // friend ------------------------------------------------------------------
  friend TlDistributeMatrix operator*(const TlDistributeMatrix& X,
  ...
  friend TlDistributeMatrix multiplicationByScaLapack(
  ...
  friend bool diagonalByScaLapack_QR(
      const TlDistributeSymmetricMatrix& inMatrix, TlVector* outEigVal,
...
// =============================================================================
// inline double TlDistributeMatrix::getDirect(const index_type row, const
