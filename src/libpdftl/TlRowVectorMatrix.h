...
class TlRowVectorMatrix : public TlVectorMatrixObject {
 public:
  explicit TlRowVectorMatrix(index_type row = 1, index_type col = 1,
                             int numOfSubunits = 1, int subunitID = 0,
                             bool isUsingMemManager = false);
  explicit TlRowVectorMatrix(const TlMatrix& rhs, int numOfSubunits = 1,
                             int subunitID = 0, bool isUsingMemManager = false);
  TlRowVectorMatrix(const TlRowVectorMatrix& rhs);
