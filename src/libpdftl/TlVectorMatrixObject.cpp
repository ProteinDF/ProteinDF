...
TlVectorMatrixObject::~TlVectorMatrixObject() { this->destroy(); }

TlVectorMatrixObject& TlVectorMatrixObject::operator=(
    const TlVectorMatrixObject& rhs) {
  if (this != &rhs) {
    this->destroy();
...
void TlVectorMatrixObject::getVector(const index_type vectorIndex, double* pBuf,
...
void TlVectorMatrixObject::setVector(const index_type vectorIndex,
                                     const TlVector& v) {
...
bool TlVectorMatrixObject::save(const std::string& basename) const {
  ...
  const std::string path =
      TlVectorMatrixObject::getFileName(basename, this->subunitID_);
...
bool TlVectorMatrixObject::saveByTheOtherType(
...
bool TlVectorMatrixObject::load(const std::string& basename, int subunitID) {
  const std::string path =
      TlVectorMatrixObject::getFileName(basename, subunitID);
