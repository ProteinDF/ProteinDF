...
protected:
    void createDataSet_common(const std::string& path, const H5::PredType& predType,
...
public:
    ...
    void write(const std::string& name, const unsigned int* pValues, std::size_t size);
    void write(const std::string& name, const long* pValues, std::size_t size);
    void write(const std::string& name, const unsigned long* pValues, std::size_t size);
...
protected:
    template<typename T>
    void write_common(const std::string& path, const T value, const H5::PredType& predType);
    template<typename T>
    void write_common(const std::string& path, const T* pValues, const H5::PredType& predType, const std::size_t size);
    template<typename T>
    void write_common(const std::string& path, const std::vector<T>& values, const H5::PredType& predType);
...
protected:
    template<typename T>
    void get(const std::string& path, const H5::PredType& predType, T* value) const;
    template<typename T>
    void get_common(const std::string& path, const H5::PredType& predType, T* pOut, const std::size_t size) const;
    template<typename T>
    void get(const std::string& path, const H5::PredType& predType, std::vector<T>* pOut) const;
...
protected:
    ...
    // -----------------------------------------------------------------
public:
    void setAttr(const std::string& path, const std::string& attrName, const char value);
    void setAttr(const std::string& path, const std::string& attrName, const unsigned char value);
    void setAttr(const std::string& path, const std::string& attrName, const int value);
    void setAttr(const std::string& path, const std::string& attrName, const unsigned int value);
    void setAttr(const std::string& path, const std::string& attrName, const long value);
    void setAttr(const std::string& path, const std::string& attrName, const unsigned long value);
    void setAttr(const std::string& path, const std::string& attrName, const float value);
    void setAttr(const std::string& path, const std::string& attrName, const double value);
    void getAttr(const std::string& path, const std::string& attrName, char* pValue);
    void getAttr(const std::string& path, const std::string& attrName, unsigned char* pValue);
    void getAttr(const std::string& path, const std::string& attrName, int* pValue);
    void getAttr(const std::string& path, const std::string& attrName, unsigned int* pValue);
    void getAttr(const std::string& path, const std::string& attrName, long* pValue);
    void getAttr(const std::string& path, const std::string& attrName, unsigned long* pValue);
    void getAttr(const std::string& path, const std::string& attrName, float* pValue);
    void getAttr(const std::string& path, const std::string& attrName, double* pValue);
...
private:
    ...
    static void getDirBaseName(const std::string& path,
                               std::string* pDirName, std::string* pBaseName);
