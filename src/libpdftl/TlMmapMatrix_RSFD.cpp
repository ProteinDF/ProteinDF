...
TlMmapMatrix_RSFD::TlMmapMatrix_RSFD(const std::string& filePath, const index_type row, const index_type col)
...
TlMatrixObject::size_type TlMmapMatrix_RSFD::getIndex(const index_type row, const index_type col) const
{
