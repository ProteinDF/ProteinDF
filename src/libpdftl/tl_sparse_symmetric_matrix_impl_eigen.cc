...
TlSparseSymmetricMatrix_ImplEigen::TlSparseSymmetricMatrix_ImplEigen(
    ...
    : TlSparseGeneralMatrix_ImplEigen(rhs.getNumOfRows(), rhs.getNumOfCols()) {
...
TlDenseGeneralMatrix_ImplEigen operator*(
    ...
    const TlSparseGeneralMatrix_ImplEigen::MatrixDataType tmp =
        mat2.matrix_.selfadjointView<Eigen::Lower>();
...
TlDenseGeneralMatrix_ImplEigen operator*(
    ...
    TlDenseGeneralMatrix_ImplEigen answer;
    answer.matrix_ =
        mat1.matrix_.selfadjointView<Eigen::Lower>() * mat2.matrix_;
