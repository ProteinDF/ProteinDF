...
#ifdef HAVE_VIENNACL
TlSparseSymmetricMatrix_Eigen::TlSparseSymmetricMatrix_Eigen(const TlSparseSymmetricMatrix_ViennaCL& rhs) {
    this->pImpl_ = new TlSparseSymmetricMatrix_ImplEigen(*(dynamic_cast<TlSparseSymmetricMatrix_ImplViennaCL*>(rhs.pImpl_)));
}
#endif // HAVE_VIENNACL
...
TlSparseSymmetricMatrix_Eigen& TlSparseSymmetricMatrix_Eigen::operator+=(const TlSparseSymmetricMatrix_Eigen& sm) {
    *(dynamic_cast<TlSparseSymmetricMatrix_ImplEigen*>(this->pImpl_)) += *(dynamic_cast<TlSparseSymmetricMatrix_ImplEigen*>(sm.pImpl_));
    return *this;
}
...
// ---------------------------------------------------------------------------
// DM(G) = DM(G) * SM(S)
TlDenseGeneralMatrix_Eigen operator*(
    const TlDenseGeneralMatrix_Eigen& dm1,
...
TlSparseGeneralMatrix_Eigen operator*(const TlSparseSymmetricMatrix_Eigen& sm1,
const TlSparseSymmetricMatrix_Eigen& sm2) {
    return TlSparseGeneralMatrix_Eigen(*(dynamic_cast<TlSparseSymmetricMatrix_ImplEigen*>(sm1.pImpl_)) * 
    *(dynamic_cast<TlSparseSymmetricMatrix_ImplEigen*>(sm2.pImpl_)));
}
