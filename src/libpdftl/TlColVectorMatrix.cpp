...
TlColVectorMatrix::TlColVectorMatrix(const index_type row, const index_type col,
                                     const int numOfSubunits,
                                     const int subunitID,
                                     bool isUsingMemManager)
    : TlVectorMatrixObject(col, row, numOfSubunits, subunitID,
                           isUsingMemManager) {}
...
void TlColVectorMatrix::resize(const index_type row, const index_type col) {
...
void TlColVectorMatrix::set(const index_type row, const index_type col,
                            const double value) {
  TlVectorMatrixObject::set_to_vm(col, row, value);
}

void TlColVectorMatrix::add(const index_type row, const index_type col,
                            const double value) {
...
void TlColVectorMatrix::getColVector(const index_type col, double* pBuf,
...
void TlColVectorMatrix::saveByTlRowVectorMatrix(
