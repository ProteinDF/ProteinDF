...
class TlSparseGeneralMatrix_ViennaCL : public TlSparseGeneralMatrixObject {
  ...
  // ---------------------------------------------------------------------------
 public:
  explicit TlSparseGeneralMatrix_ViennaCL(const TlMatrixObject::index_type row = 1,
  ...
  TlSparseGeneralMatrix_ViennaCL(const TlSparseGeneralMatrix_ImplViennaCL& rhs);
  ...
  // ---------------------------------------------------------------------------
 public:
  TlSparseGeneralMatrix_ViennaCL& operator=(const TlSparseGeneralMatrix_ViennaCL& rhs);
  TlSparseGeneralMatrix_ViennaCL& operator+=(const TlSparseGeneralMatrix_ViennaCL& rhs);
  TlSparseGeneralMatrix_ViennaCL& operator-=(const TlSparseGeneralMatrix_ViennaCL& rhs);
  ...
  // SM(G) = SM(G) * SM(G)
  friend TlSparseGeneralMatrix_ViennaCL operator*(const TlSparseGeneralMatrix_ViennaCL& sm1, const TlSparseGeneralMatrix_ViennaCL& sm2);
  // SM(G) = SM(G) * SM(S)
  friend TlSparseGeneralMatrix_ViennaCL operator*(const TlSparseGeneralMatrix_ViennaCL& sm1, const TlSparseSymmetricMatrix_ViennaCL& sm2);
  // SM(G) = SM(S) * SM(G)
  friend TlSparseGeneralMatrix_ViennaCL operator*(const TlSparseSymmetricMatrix_ViennaCL& sm1, const TlSparseGeneralMatrix_ViennaCL& sm2);
  // DV = SM(G) * DV
