...
TlHdf5Utils::TlHdf5Utils(const std::string& path)
    : file_() 
{
...
TlHdf5Utils::~TlHdf5Utils()
{
    this->file_.close();
}


void TlHdf5Utils::flush() const
{
    this->file_.flush(H5F_SCOPE_LOCAL);
}

// =====================================================================
// create dataset
// =====================================================================
void TlHdf5Utils::createDataSet_int(const std::string& path, const std::size_t size)
{
    this->createDataSet_common(path, H5::PredType::NATIVE_INT, size);
}


void TlHdf5Utils::createDataSet_double(const std::string& path, const std::size_t size)
{
    this->createDataSet_common(path, H5::PredType::NATIVE_DOUBLE, size);
}


void TlHdf5Utils::createDataSet_common(const std::string& path, const H5::PredType& predType,
...
// =====================================================================
template<typename T>
void TlHdf5Utils::write_common(const std::string& path, const T value, const H5::PredType& predType)
{
    this->prepareToWrite(path);
...
template<typename T>
void TlHdf5Utils::write_common(const std::string& path, const T* pValues, const H5::PredType& predType, const std::size_t size)
{
    this->prepareToWrite(path);
...
void TlHdf5Utils::write(const std::string& name, const int* pValues, std::size_t size)
{
    this->write_common<int>(name, pValues, H5::PredType::NATIVE_INT, size);
}


void TlHdf5Utils::write(const std::string& name, const unsigned int* pValues, std::size_t size)
{
    this->write_common<unsigned int>(name, pValues, H5::PredType::NATIVE_ULONG, size);
}


void TlHdf5Utils::write(const std::string& name, const long* pValues, std::size_t size)
{
    this->write_common<long>(name, pValues, H5::PredType::NATIVE_LONG, size);
}


void TlHdf5Utils::write(const std::string& name, const unsigned long* pValues, std::size_t size)
{
    this->write_common<unsigned long>(name, pValues, H5::PredType::NATIVE_ULONG, size);
}


void TlHdf5Utils::write(const std::string& name, const float* pValues, std::size_t size)
{
    this->write_common<float>(name, pValues, H5::PredType::NATIVE_FLOAT, size);
}


void TlHdf5Utils::write(const std::string& name, const double* pValues, std::size_t size)
{
...
template<typename T>
void TlHdf5Utils::write_common(const std::string& path, const std::vector<T>& values, const H5::PredType& predType)
{
    this->write_common<T>(path, values.data(), predType, values.size());
}


void TlHdf5Utils::write(const std::string& path, const std::vector<char>& values)
{
    this->write_common<char>(path, values, H5::PredType::NATIVE_CHAR);
}


void TlHdf5Utils::write(const std::string& path, const std::vector<unsigned char>& values)
{
    this->write_common<unsigned char>(path, values, H5::PredType::NATIVE_UCHAR);
}


void TlHdf5Utils::write(const std::string& path, const std::vector<int>& values)
{
    this->write_common<int>(path, values, H5::PredType::NATIVE_INT);
}


void TlHdf5Utils::write(const std::string& path, const std::vector<unsigned int>& values)
{
    this->write_common<unsigned int>(path, values, H5::PredType::NATIVE_UINT);
}


void TlHdf5Utils::write(const std::string& path, const std::vector<long>& values)
{
    this->write_common<long>(path, values, H5::PredType::NATIVE_LONG);
}


void TlHdf5Utils::write(const std::string& path, const std::vector<unsigned long>& values)
{
    this->write_common<unsigned long>(path, values, H5::PredType::NATIVE_ULONG);
}


void TlHdf5Utils::write(const std::string& path, const std::vector<float>& values)
{
    this->write_common<float>(path, values, H5::PredType::NATIVE_FLOAT);
}


void TlHdf5Utils::write(const std::string& path, const std::vector<double>& values)
{
    this->write_common<double>(path, values, H5::PredType::NATIVE_DOUBLE);
}


void TlHdf5Utils::write(const std::string& path, const std::vector<std::string>& values)
{
    this->prepareToWrite(path);
...
// =====================================================================
template<typename T>
void TlHdf5Utils::get(const std::string& path, const H5::PredType& predType, T* pOut) const
{
    assert(pOut != NULL);
...
template<typename T>
void TlHdf5Utils::get_common(const std::string& path, const H5::PredType& predType, T* pOut, const std::size_t size) const
{
    const H5::DataSet dataSet = this->file_.openDataSet(path);
...
void TlHdf5Utils::get(const std::string& path, double* pOut, const std::size_t size) const
{
...
template<typename T>
void TlHdf5Utils::get(const std::string& path, const H5::PredType& predType, std::vector<T>* pOut) const
{
    const H5::DataSet dataSet = this->file_.openDataSet(path);
...
void TlHdf5Utils::get(const std::string& path, std::vector<unsigned char>* pOut) const
{
    this->get<unsigned char>(path, H5::PredType::NATIVE_UCHAR, pOut);
}
...
void TlHdf5Utils::get(const std::string& path, std::vector<unsigned int>* pOut) const
{
    this->get<unsigned int>(path, H5::PredType::NATIVE_UINT, pOut);
}
...
void TlHdf5Utils::get(const std::string& path, std::vector<unsigned long>* pOut) const
{
    this->get<unsigned long>(path, H5::PredType::NATIVE_ULONG, pOut);
}
...
void TlHdf5Utils::get(const std::string& path, std::vector<double>* pOut) const
{
    this->get<double>(path, H5::PredType::NATIVE_DOUBLE, pOut);
}

void TlHdf5Utils::get(const std::string& path, std::vector<std::string>* pOut) const
{
    const H5::DataSet dataSet = this->file_.openDataSet(path);
...
void TlHdf5Utils::setAttr(const std::string& path, const std::string& attrName, const char value)
{
    this->setAttr(path, attrName, H5::PredType::NATIVE_CHAR, value);
}

void TlHdf5Utils::setAttr(const std::string& path, const std::string& attrName, const unsigned char value)
{
    this->setAttr(path, attrName, H5::PredType::NATIVE_UCHAR, value);
}

void TlHdf5Utils::setAttr(const std::string& path, const std::string& attrName, const int value)
{
    this->setAttr(path, attrName, H5::PredType::NATIVE_INT, value);
}

void TlHdf5Utils::setAttr(const std::string& path, const std::string& attrName, const unsigned int value)
{
    this->setAttr(path, attrName, H5::PredType::NATIVE_UINT, value);
}

void TlHdf5Utils::setAttr(const std::string& path, const std::string& attrName, const long value)
{
    this->setAttr(path, attrName, H5::PredType::NATIVE_LONG, value);
}

void TlHdf5Utils::setAttr(const std::string& path, const std::string& attrName, const unsigned long value)
{
    this->setAttr(path, attrName, H5::PredType::NATIVE_ULONG, value);
}

void TlHdf5Utils::setAttr(const std::string& path, const std::string& attrName, const float value)
{
    this->setAttr(path, attrName, H5::PredType::NATIVE_FLOAT, value);
}

void TlHdf5Utils::setAttr(const std::string& path, const std::string& attrName, const double value)
{
...
void TlHdf5Utils::getAttr(const std::string& path, const std::string& attrName, char* pValue)
{
    this->getAttr(path, attrName, H5::PredType::NATIVE_CHAR, pValue);
}

void TlHdf5Utils::getAttr(const std::string& path, const std::string& attrName, unsigned char* pValue)
{
    this->getAttr(path, attrName, H5::PredType::NATIVE_UCHAR, pValue);
}

void TlHdf5Utils::getAttr(const std::string& path, const std::string& attrName, int* pValue)
{
    this->getAttr(path, attrName, H5::PredType::NATIVE_INT, pValue);
}

void TlHdf5Utils::getAttr(const std::string& path, const std::string& attrName, unsigned int* pValue)
{
    this->getAttr(path, attrName, H5::PredType::NATIVE_UINT, pValue);
}

void TlHdf5Utils::getAttr(const std::string& path, const std::string& attrName, long* pValue)
{
    this->getAttr(path, attrName, H5::PredType::NATIVE_LONG, pValue);
}

void TlHdf5Utils::getAttr(const std::string& path, const std::string& attrName, unsigned long* pValue)
{
    this->getAttr(path, attrName, H5::PredType::NATIVE_ULONG, pValue);
}

void TlHdf5Utils::getAttr(const std::string& path, const std::string& attrName, float* pValue)
{
    this->getAttr(path, attrName, H5::PredType::NATIVE_FLOAT, pValue);
}

void TlHdf5Utils::getAttr(const std::string& path, const std::string& attrName, double* pValue)
{
...
bool TlHdf5Utils::hasGroup(const H5::CommonFG* pParent, const std::string& name) 
{
    return this->hasObject(pParent, name, H5O_TYPE_GROUP);
}


bool TlHdf5Utils::hasDataSet(const H5::CommonFG* pParent, const std::string& name) 
{
    return this->hasObject(pParent, name, H5O_TYPE_DATASET);
}


bool TlHdf5Utils::hasObject(const H5::CommonFG* pParent, const std::string& name,
                            const H5O_type_t requestType)
{
    ...
    // std::cerr << "hasObject():" << name << "> " << cname << ", " << rest << std::endl;
    ...
    if (rest.length() > 0) {
        if (this->hasGroup(pParent, cname)) {
            ...
            // NOT FOUND!
            // std::cerr << "path not found: " << name << "(" << cname << ")" << std::endl;
        }
    } else {
...
bool TlHdf5Utils::hasChildObject(const H5::CommonFG* pParent, const std::string& name,
                                 const H5O_type_t requestType)
{
    bool answer = false;
...
// ---------------------------------------------------------------------------
H5::Group TlHdf5Utils::getGroup(const H5::CommonFG* pParent, const std::string& name)
{
...
std::string TlHdf5Utils::getChildName(const std::string& path, std::string* pRest)
{
    std::size_t offset = 0;
    ...
    // std::cerr << "getChildName: " << path << "> " << answer << ":" << rest << std::endl;
...
void TlHdf5Utils::getDirBaseName(const std::string& path,
                                 std::string* pDirName,
