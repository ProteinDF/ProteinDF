...
protected:
    ...
    double epsilonC(const double A, const double b, const double c, const double x0, const double x);

    double h(const double dEc_p, const double dEc_f, const double dEc_a);

    double epsilonCPrime(const double A, const double b, const double c, const double x0, const double x);
