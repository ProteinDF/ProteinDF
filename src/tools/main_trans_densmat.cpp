...
void usage(const std::string& progname) {
    ...
    std::cout << " default old matrix file is old.mtx, and new matrix file is "
                 "new.mtx."
              << std::endl;
    std::cout << std::endl;
    std::cout << "options:" << std::endl;
    std::cout << "-o FILE:    old ProteinDF parameter file (default: "
                 "pdfparam.mpac.old)"
              << std::endl;
    std::cout
        ...
        << std::endl;
    std::cout
        << "-s FILE:    overlap matrix (default: fl_Work/fl_Mtr_Spq.matrix)"
        << std::endl;
}
