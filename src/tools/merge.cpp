...
//   std::map<std::string, std::string> param2 = getAvsFieldDataHeader(&ifs2);
...
//   for (std::map<std::string, std::string>::const_iterator p = param2.begin();
//        p != param2.end(); ++p) {
//     std::cerr << p->first << " = " << p->second << std::endl;
//   }
...
//   if (size1 != size2) {
//     std::cerr << TlUtils::format("data size mismatch. (%ld, %ld)", size1, size2)
//        << std::endl;
//     return EXIT_FAILURE;
//   }
...
//  std::cerr << "warning!: 1st file coord block is different from 2nd one.:"
//        << "(" << v1 << ", " << v2 << ")"
//        << std::endl;
//  //isWarned = true;
//       }
