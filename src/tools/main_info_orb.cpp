...
void printOrbInfo(const TlOrbitalInfo& tlOrbInfo, std::size_t orb) {
  ...
  std::cout << TlUtils::format("%d th orbital information:", orb) << std::endl;
  std::cout
      << TlUtils::format(
...
void showHelp() {
  ...
  std::cout << " index:        Specify orbital indeces which begin from '0' to "
               "output."
            << std::endl;
  std::cout << "               Output all orbitals if no entry." << std::endl;
  std::cout << " -a:           Atom index mode: index means atom serial number."
            << std::endl;
  std::cout
