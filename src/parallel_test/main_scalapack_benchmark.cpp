...
void inverse()
{
    ...
    msg(TlUtils::format("elapse time for loading: %f [sec]", tlTime.getElapseTime()));

    tlTime.start();
    matrix.inverse();

    msg(TlUtils::format("elapse time for inverse: %f [sec]", tlTime.getElapseTime()));
...
void diagonal()
{
    ...
    msg(TlUtils::format("elapse time for diagonal: %f [sec]", tlTime.getElapseTime()));
