...
INSTANTIATE_TYPED_TEST_SUITE_P(Eigen_FP32, DenseGeneralMatrixTest, TlDenseGeneralMatrix_EigenFloat);
#endif  // HAVE_EIGEN
...
INSTANTIATE_TYPED_TEST_SUITE_P(ViennaCL_FP32, DenseGeneralMatrixTest, TlDenseGeneralMatrix_ViennaCLFloat);
#endif  // HAVE_VIENNACL
