...
INSTANTIATE_TYPED_TEST_CASE_P(Lapack, DenseSymmetricMatrixTest,
                              TlDenseSymmetricMatrix_Lapack);

#ifdef HAVE_EIGEN
INSTANTIATE_TYPED_TEST_CASE_P(Eigen, DenseSymmetricMatrixTest,
                              TlDenseSymmetricMatrix_Eigen);
#endif  // HAVE_EIGEN

#ifdef HAVE_VIENNACL
INSTANTIATE_TYPED_TEST_CASE_P(ViennaCL, DenseSymmetricMatrixTest,
