...
#include "tl_matrix_blas_column_major.h"
...
// [ 3  4  5 ]
// [ 6  7  8 ]
TlMatrixBlasColumnMajor getMatrixA() {
    TlMatrixBlasColumnMajor a(3, 3);
    a(0, 0) = 0.0;
    a(0, 1) = 1.0;
    a(0, 2) = 2.0;
    a(1, 0) = 3.0;
...
// [ 1  4  7 ]
// [ 2  5  8 ]
TlMatrixBlasColumnMajor getMatrixB() {
    TlMatrixBlasColumnMajor b(3, 3);
    b(0, 0) = 0.0;
    b(1, 0) = 1.0;
    b(2, 0) = 2.0;
    b(0, 1) = 3.0;
...
// [ 2  -1  1 ]
// [ 4   3  2 ]
TlMatrixBlasColumnMajor getMatrixC() {
    TlMatrixBlasColumnMajor b(3, 3);
    b(0, 0) = 1.0;
    b(1, 0) = 2.0;
    b(2, 0) = 3.0;
...
// test
// -----------------------------------------------------------------------------
TEST(TlMatrixBlasColumnMajor, constructer) {
    TlMatrixBlasColumnMajor a(3, 3);
...
TEST(TlMatrixBlasColumnMajor, constructByTlSerializedData) {
    // TODO
}

TEST(TlMatrixBlasColumnMajor, vtr2mat) {
    // TODO
}

TEST(TlMatrixBlasColumnMajor, copyConstructer) {
    TlMatrixBlasColumnMajor a = getMatrixA();
    TlMatrixBlasColumnMajor c(a);
...
TEST(TlMatrixBlasColumnMajor, symmat2mat) {
    TlDenseSymmetricMatrix_BLAS_Old s(4);
    s(0, 0) = 1.0;
    s(1, 2) = 2.0;
    s(3, 2) = 3.0;

    TlMatrixBlasColumnMajor m(s);
...
TEST(TlMatrixBlasColumnMajor, resize) {
    TlMatrixBlasColumnMajor a(2, 3);
    a(0, 1) = 2.0;
    a(1, 2) = -4.0;
...
TEST(TlMatrixBlasColumnMajor, operator_eq) {
    TlMatrixBlasColumnMajor a = getMatrixA();
    TlMatrixBlasColumnMajor c;
...
TEST(TlMatrixBlasColumnMajor, operator_add) {
    TlMatrixBlasColumnMajor a = getMatrixA();
    TlMatrixBlasColumnMajor b = getMatrixB();

    TlMatrixBlasColumnMajor c = a + b;
...
TEST(TlMatrixBlasColumnMajor, operator_iadd) {
    TlMatrixBlasColumnMajor a = getMatrixA();
    TlMatrixBlasColumnMajor b = getMatrixB();
...
TEST(TlMatrixBlasColumnMajor, save) {
    TlMatrixBlasColumnMajor m = getMatrixA();
    m.save(mat_path);
}

TEST(TlMatrixBlasColumnMajor, load) {
    TlMatrixBlasColumnMajor a;
    a.load(mat_path);
...
#ifdef HAVE_HDF5
TEST(TlMatrixBlasColumnMajor, hdf5) {
    TlMatrixBlasColumnMajor m = getMatrixA();
...
TEST(TlMatrixBlasColumnMajor, inverse)

{
    TlMatrixBlasColumnMajor a = getMatrixC();
    TlMatrixBlasColumnMajor b = a;
...
TEST(TlMatrixBlasColumnMajor, operator_mul_AB) {
    TlMatrixBlasColumnMajor a = getMatrixA();
    TlMatrixBlasColumnMajor b = getMatrixB();
    TlMatrixBlasColumnMajor c = a * b;
...
TEST(TlMatrixBlasColumnMajor, operator_mul_AX) {
    TlMatrixBlasColumnMajor a = getMatrixA();
    TlVector x(3);
    x[0] = 1.0;
    x[1] = 2.0;
...
TEST(TlMatrixBlasColumnMajor, operator_mul_X) {
    TlMatrixBlasColumnMajor a = getMatrixA();
    TlVector x(3);
    x[0] = 1.0;
    x[1] = 2.0;
...
TEST(TlMatrixBlasColumnMajor, dot) {
    TlMatrixBlasColumnMajor a = getMatrixA();
    TlMatrixBlasColumnMajor b = getMatrixB();
    a.dot(b);
...
TEST(TlMatrixBlasColumnMajor, sum) {
    TlMatrixBlasColumnMajor a = getMatrixA();
    double s = a.sum();
...
TEST(TlMatrixBlasColumnMajor, solveLinearLeastSquaresProblem) {
    TlMatrixBlasColumnMajor A(6, 5);
    A(0, 0) = -0.09;
    A(0, 1) = 0.14;
    A(0, 2) = -0.46;
    A(0, 3) = 0.68;
    ...
    TlMatrixBlasColumnMajor X = A.solveLinearLeastSquaresProblem(B);
    // X.print(std::cout);

    TlMatrixBlasColumnMajor AX = A * X;
    // AX.print(std::cout);
