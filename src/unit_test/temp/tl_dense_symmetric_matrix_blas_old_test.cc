...
TEST(TlDenseSymmetricMatrix_BLAS_Old, copyConstructer) {
  TlDenseSymmetricMatrix_BLAS_Old a = getSymMatrixA<TlDenseSymmetricMatrix_BLAS_Old>();
...
TEST(TlDenseSymmetricMatrix_BLAS_Old, operator_add) {
  TlDenseSymmetricMatrix_BLAS_Old a = getSymMatrixA<TlDenseSymmetricMatrix_BLAS_Old>();
  TlDenseSymmetricMatrix_BLAS_Old b = getSymMatrixB<TlDenseSymmetricMatrix_BLAS_Old>();
...
TEST(TlDenseSymmetricMatrix_BLAS_Old, choleskyDecomposition) {
  TlDenseSymmetricMatrix_BLAS_Old A = getSymMatrixC<TlDenseSymmetricMatrix_BLAS_Old>();
  // A.print(std::cout);
