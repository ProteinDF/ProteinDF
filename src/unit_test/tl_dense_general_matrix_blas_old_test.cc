...
TEST(TlDenseGeneralMatrix_BLAS_old, copyConstructer) {
  TlDenseGeneralMatrix_BLAS_old a = getMatrixA<TlDenseGeneralMatrix_BLAS_old>();
...
TEST(TlDenseGeneralMatrix_BLAS_old, operator_add) {
  TlDenseGeneralMatrix_BLAS_old a = getMatrixA<TlDenseGeneralMatrix_BLAS_old>();
  TlDenseGeneralMatrix_BLAS_old b = getMatrixB<TlDenseGeneralMatrix_BLAS_old>();
...
TEST(TlDenseGeneralMatrix_BLAS_old, save) {
  TlDenseGeneralMatrix_BLAS_old m = getMatrixA<TlDenseGeneralMatrix_BLAS_old>();
...
{
  TlDenseGeneralMatrix_BLAS_old a = getMatrixC<TlDenseGeneralMatrix_BLAS_old>();
