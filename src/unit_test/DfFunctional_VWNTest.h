#ifndef DFFUNCTIONAL_VWNTEST_H
#define DFFUNCTIONAL_VWNTEST_H

#include <cppunit/extensions/HelperMacros.h>

#include "DfFunctional_VWN.h"

class DfFunctional_VWNTest : public CppUnit::TestFixture{
  CPPUNIT_TEST_SUITE(DfFunctional_VWNTest);
