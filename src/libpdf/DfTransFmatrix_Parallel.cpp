...
void DfTransFmatrix_Parallel::DfTrsFmatMain_SCALAPACK() {
  switch (this->m_nMethodType) {
    case METHOD_RKS:
      DfTransFmatrix::main<TlDenseGeneralMatrix_blacs,
                           TlDenseSymmetricMatrix_blacs>(RUN_RKS);
      break;

    case METHOD_UKS:
      DfTransFmatrix::main<TlDenseGeneralMatrix_blacs,
                           TlDenseSymmetricMatrix_blacs>(RUN_UKS_ALPHA);
      DfTransFmatrix::main<TlDenseGeneralMatrix_blacs,
                           TlDenseSymmetricMatrix_blacs>(RUN_UKS_BETA);
      break;

    case METHOD_ROKS:
      DfTransFmatrix::main<TlDenseGeneralMatrix_blacs,
                           TlDenseSymmetricMatrix_blacs>(RUN_ROKS);
      break;
...
void DfTransFmatrix_Parallel::DfTrsFmatQclo_SCALAPACK(
  ...
  switch (this->m_nMethodType) {
    case METHOD_RKS:
      DfTransFmatrix::main<TlDenseGeneralMatrix_blacs,
                           TlDenseSymmetricMatrix_blacs>(RUN_RKS, fragname,
                                                         true);
      break;
    ...
    case METHOD_UKS:
      DfTransFmatrix::main<TlDenseGeneralMatrix_blacs,
                           TlDenseSymmetricMatrix_blacs>(RUN_UKS_ALPHA,
                                                         fragname, true);
      DfTransFmatrix::main<TlDenseGeneralMatrix_blacs,
                           TlDenseSymmetricMatrix_blacs>(RUN_UKS_BETA, fragname,
                                                         true);
      break;

    case METHOD_ROKS:
      DfTransFmatrix::main<TlDenseGeneralMatrix_blacs,
                           TlDenseSymmetricMatrix_blacs>(RUN_ROKS, fragname,
                                                         true);
      break;
