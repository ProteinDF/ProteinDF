...
class DfTaskCtrl : public DfObject {
 public:
  ...
  struct Task4 {
   public:
    Task4() : shellIndex1(0), shellIndex2(0), shellIndex3(0), shellIndex4(0) {}

    Task4(const Task4& rhs)
        : shellIndex1(rhs.shellIndex1),
          shellIndex2(rhs.shellIndex2),
          shellIndex3(rhs.shellIndex3),
          shellIndex4(rhs.shellIndex4) {}
 ...
 protected:
  typedef std::map<index_type, std::vector<std::vector<index_type> > >
      DistributedCutoffTable;
 ...
 protected:
  ...
  ShellArray selectShellArrayByDistribution(
  ...
  int getShellQuartetType(const TlOrbitalInfoObject& orbitalInfo_PQ,
                          ...
                          const int shellTypeR, const int shellTypeS);
  ...
  DistributedCutoffTable makeDistributedCutoffTable(
      const TlOrbitalInfoObject& orbitalInfo);
  ...
  std::size_t getTotalCalcAmount2(const TlOrbitalInfoObject& orbitalInfo1,
                                  ...
                                  const ShellArrayTable& shellArrayTable2,
                                  const DistributedCutoffTable& dct);
  std::size_t getTotalCalcAmount4(
      const TlOrbitalInfoObject& orbitalInfo,
  ...
  std::size_t getTotalCalcAmount4(
      ...
      const TlOrbitalInfoObject& orbitalInfo2,
      const ShellPairArrayTable& shellPairArrayTable,
      const DistributedCutoffTable& dct1, const DistributedCutoffTable& dct2);
