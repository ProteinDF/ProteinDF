...
class DfCD_Parallel : public DfCD {
   ...
   protected:
    ...
    void expandJMatrixD(const TlDenseVector_Lapack& vJ,
                        const PQ_PairArray& I2PQ,
   ...
   protected:
    ...
    // ----------------------------------------------------------------------------
   protected:
    typedef void (DfCD_Parallel::*GetSuperMatrixElementsFuncP)(
    ...
    calcCholeskyVectorsOnTheFlyS_new(
        ...
        GetSuperMatrixElementsFuncP getSuperMatrixElements);
