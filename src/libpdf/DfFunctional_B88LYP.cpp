...
double DfFunctional_B88LYP::getFunctional(const double dRhoA,
    ...
    const double ex = this->m_Becke88.getFunctional(dRhoA, dRhoB, dGammaAA,
                                                    dGammaAB, dGammaBB);
    const double ec =
...
void DfFunctional_B88LYP::getDerivativeFunctional(
    ...
    double dRoundF_roundGammaAA_X, dRoundF_roundGammaAB_X,
        dRoundF_roundGammaBB_X;
    double dRoundF_roundGammaAA_C, dRoundF_roundGammaAB_C,
    ...
    *pRoundF_roundGammaBB = dRoundF_roundGammaBB_X + dRoundF_roundGammaBB_C;
    ...
    //   std::cerr << TlUtils::format("RA=%5e, RB=%5e, GAA=%5e, GAB=%5e,
    //   GBB=%5e",
