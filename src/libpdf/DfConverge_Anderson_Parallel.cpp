...
void DfConverge_Anderson_Parallel::convergeRhoTilde_ScaLAPACK() {
    switch (this->m_nMethodType) {
        case METHOD_RKS:
            DfConverge_Anderson::convergeRhoTilde<TlDenseVector_Scalapack>(
                DfObject::RUN_RKS);
            break;
        case METHOD_UKS:
            DfConverge_Anderson::convergeRhoTilde<TlDenseVector_Scalapack>(
        ...
        default:
            std::cerr << "program error. "
                         "@DfConverge_Anderson_Parallel::convergeRhoTilde()"
                      << std::endl;
            break;
    }
}
...
void DfConverge_Anderson_Parallel::convergeKSMatrix_ScaLAPACK() {
    switch (this->m_nMethodType) {
        case METHOD_RKS:
            DfConverge_Anderson::convergeKSMatrix<
                TlDenseSymmetricMatrix_Scalapack, TlDenseVector_Scalapack>(
                DfObject::RUN_RKS);
            break;
        case METHOD_UKS:
            DfConverge_Anderson::convergeKSMatrix<
        ...
        default:
            std::cerr << "program error. "
                         "@DfConverge_Anderson_Parallel::convergeKSMatrix()"
                      << std::endl;
            break;
    }
}
...
void DfConverge_Anderson_Parallel::convergePMatrix_ScaLAPACK() {
    switch (this->m_nMethodType) {
        ...
        default:
            std::cerr << "program error. "
                         "@DfConverge_Anderson_Distribute::convergePMatrix()"
                      << std::endl;
            break;
    }
}
