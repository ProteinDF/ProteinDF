...
DfFunctional_B3LYP::DfFunctional_B3LYP() {
    ...
    this->numOfDerivativeFunctionalTerms_ = numOfDerivativeFunctionalTerms_LDA +
...
void DfFunctional_B3LYP::getDerivativeFunctional(
    ...
    *pRoundF_roundGammaAA = B88_COEF * dRoundF_roundGammaAA_B88 +
                            LYP_COEF * dRoundF_roundGammaAA_LYP;
    *pRoundF_roundGammaAB = B88_COEF * dRoundF_roundGammaAB_B88 +
                            LYP_COEF * dRoundF_roundGammaAB_LYP;
    *pRoundF_roundGammaBB = B88_COEF * dRoundF_roundGammaBB_B88 +
                            LYP_COEF * dRoundF_roundGammaBB_LYP;
}
