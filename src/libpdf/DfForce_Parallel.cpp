...
void DfForce_Parallel::calcForceFromCoulomb_exact_replicated(const RUN_TYPE runType)
{
...
DfCalcGridX* DfForce_Parallel::getCalcGridObj()
{
    ...
    DfCalcGridX* pDfCalcGrid = new DfCalcGridX_Parallel(&(this->pdfParamForForce_));
