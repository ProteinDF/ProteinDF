...
class DfFunctional_LYP : public DfFunctional_GGA {
 ...
 private:
  double LYP(double dRhoA, double dRhoB, double dGammaAA, double dGammaAB,
             double dGammaBB);
  ...
  void roundLYP_roundGamma(double dRho, double dRhoA, double dRhoB,
                           ...
                           double& dRoundLYP_roundGammaBB);
  void roundLYP_roundGamma(double dRho, double dRhoA, double dOmega,
                           double dDelta, double& dRoundLYP_roundGammaAA,
                           double& dRoundLYP_roundGammaAB);
  ...
  void roundRoundLYP_roundRhoRoundGamma(
      double dRho, double dRhoA, double dRhoB, double dInvRho, double dRhoAB,
      double dOmega, double dOmegaPrime, double dDelta, double dDeltaPrime,
  ...
  void roundRoundLYP_roundRhoRoundGamma(
      double dRho, double dRhoA, double dInvRho, double dRhoAB, double dOmega,
      double dOmegaPrime, double dDelta, double dDeltaPrime,
      double* pRoundRoundLYP_roundRhoARoundGammaAA,
      double* pRoundRoundLYP_roundRhoARoundGammaAB);
