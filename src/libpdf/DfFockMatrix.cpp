...
void DfFockMatrix::mainDIRECT_ROKS() {
  this->mainDIRECT_ROKS<TlMatrix, TlSymmetricMatrix, TlVector, DfEriX,
                        DfOverlapX>();
}
...
void DfFockMatrix::setCoulomb(const METHOD_TYPE nMethodType,
  ...
  if (this->J_engine_ == J_ENGINE_RI_J) {
    ...
    //     this->setCoulomb<TlSymmetricMatrix, TlVector, DfEriX>(nMethodType,
    //     J);
    // } else {
...
TlSymmetricMatrix DfFockMatrix::getFpqMatrix(const RUN_TYPE nRunType,
...
// TlSymmetricMatrix& F)
// {
//     DfObject::saveFpqMatrix<TlSymmetricMatrix>(nRunType, this->m_nIteration,
//     F);
// }
