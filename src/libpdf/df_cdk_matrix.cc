...
void DfCdkMatrix::getK_L(DfObject::RUN_TYPE runType) {
    ...
    if (this->useMmapMatrix_) {
        ...
        switch (this->sparseMatrixLevel_) {
            case 1: {
                this->log_.info(
                    "use sparse matrix to transpose the cholesky vector.");
            ...
            default: {
                ...
                this->getK_byLjk<TlDenseGeneralMatrix_mmap, SymmetricMatrix,
                                 Vector>(runType);
            } break;
        }
        ...
        // v1
        this->getK_byLjk<TlDenseGeneralMatrix_arrays_ColOriented,
                         SymmetricMatrix, Vector>(runType);
    }
    //       break;
