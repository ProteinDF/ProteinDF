...
#define OVP_STATE_MAX                                                \
    (OVP_A_BAR_MAX * OVP_B_BAR_MAX * OVP_C_BAR_MAX * OVP_D_BAR_MAX * \
...
class DfOverlapEngine : public DfEngineObject {
   public:
    ...
    struct OvpState {
        OvpState(int inAbar, int inBbar, int inCbar, int inDbar, int inA,
                 int inB, int inC, int inD)
            : a_bar(inAbar),
              b_bar(inBbar),
              c_bar(inCbar),
              d_bar(inDbar),
   ...
   private:
    ...
    void calc0(const Query& query, const TlPosition& A, const TlPosition& B,
               ...
               const PGTOs& PGTOs_B, const PGTOs& PGTOs_C,
               const PGTOs& PGTOs_D);
