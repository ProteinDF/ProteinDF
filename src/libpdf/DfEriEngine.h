...
public:
    ...
    public:
        ...
        PGTO_Pair(const int a, const double coefA, const double expA,
                  ...
                  const TlPosition& A, const TlPosition& B)
...
private:
    ...
    public:
        ...
        E4(const TlPosition& P, const TlPosition& Q, double sigma_P,
           double sigma_Q, double U_P, double U_Q) {
            this->R = Q - P;
...
private:
    ...
    public:
        ...
        int index() const {
            const int v =
                ((a_prime * ERI_B_PRIME_MAX) + b_prime) * ERI_P_PRIME_MAX +
                p_prime;
            return v;
        }
...
private:
    ...
    public:
        ...
        // for debug
        std::string debugOut() const {
            return TlUtils::format("(%d %d, %d %d %d, %d %d %d|", a_bar, b_bar,
                                   a, b, p, a_prime, b_prime, p_prime);
        }
...
private:
    ...
    // int index_contract(const int a_prime, const int b_prime, const int
    // p_prime) const;
    ...
    void transform6Dto5D_k(const int I_, const int J_, const int K_,
                           ...
                           const double* pInput, double* pOutput);
    void transform6Dto5D_l(const int I_, const int J_, const int K_,
