...
void DfConverge_Damping_Parallel::convergeRhoTilde_ScaLAPACK() {
  switch (this->m_nMethodType) {
    ...
    default:
      std::cerr
          << "program error. @DfConverge_Damping_Parallel::convergeRhoTilde()"
          << std::endl;
      break;
  }
}
...
void DfConverge_Damping_Parallel::convergeKSMatrix_ScaLAPACK() {
  switch (this->m_nMethodType) {
    ...
    default:
      std::cerr
          << "program error. @DfConverge_Damping_Parallel::convergeKSMatrix()"
          << std::endl;
      break;
  }
}
...
void DfConverge_Damping_Parallel::convergePMatrix_ScaLAPACK() {
  switch (this->m_nMethodType) {
    ...
    default:
      std::cerr
          << "program error. @DfConverge_Damping_Distribute::convergePMatrix()"
          << std::endl;
      break;
  }
}
