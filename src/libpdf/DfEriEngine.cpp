...
DfEriEngine::DfEriEngine() : log_(TlLogging::getInstance()) {
  ...
  // abp(r)cdq
  const int P_PRIME_MAX3 = ERI_P_PRIME_MAX * ERI_P_PRIME_MAX * ERI_P_PRIME_MAX;
          ...
          for (int q_b = 0; q_b < (ERI_B_MAX + 1); ++q_b) {
            ...
            for (int bra_cs_index = 0; bra_cs_index < max_bra_cs_index;
              ...
              for (int p = 0; p <= angularMomentumP; ++p) {
                const ERI_State bra_state(a_bar, b_bar, a, b, p, a_prime,
                                          b_prime, p_prime);
                const int braStateIndex = bra_state.index();

                // const TlAngularMomentumVectorSet amvs_p(p);
                // const int numOf_amvs_p = amvs_p.size(); // amvs_p
                // の数だけで十分
                this->ERI_bra_[braStateIndex].resize(numOf_amvs_p_max);
                this->ERI_ket_[braStateIndex].resize(numOf_amvs_p_max);
              }
            }
          }
        }
...
DfEriEngine::CGTO_Pair DfEriEngine::getCGTO_pair(
  ...
  for (int pP = 0; pP < numOfContractionsP; ++pP) {
    ...
    for (int pQ = 0; pQ < numOfContractionsQ; ++pQ) {
      ...
      PGTO_Pair pgtoPair(shellTypeP, coefP, expP, shellTypeQ, coefQ, expQ, P,
                         Q);
...
void DfEriEngine::calc0(const AngularMomentum2& qAB,
  ...
  // for debug
  {
    const std::string AB_str =
        TlUtils::format("[%f %f %f]", this->AB_[0], this->AB_[1], this->AB_[2]);
    const std::string CD_str =
        TlUtils::format("[%f %f %f]", this->CD_[0], this->CD_[1], this->CD_[2]);
    std::cerr << TlUtils::format(
        ...
        for (int iDbar = 0; iDbar < numOfAmvsDbar; ++iDbar) {
          ...
          for (int iA = 0; iA < numOfAmvsA; ++iA) {
            ...
            for (int iB = 0; iB < numOfAmvsB; ++iB) {
              ...
              const int bra_index =
                  ((iAbar * numOfAmvsBbar + iBbar) * numOfAmvsA + iA) *
                      numOfAmvsB +
                  iB;
              ...
              for (int iC = 0; iC < numOfAmvsC; ++iC) {
                ...
                for (int iD = 0; iD < numOfAmvsD; ++iD) {
                  ...
                  pOutput[index] +=
                      this->ERI_ket_[ketStateIndex][ket_index][bra_index];
                  ++index;
                  ...
                  // for debug
                  {
                    ...
                    std::cerr
                        << TlUtils::format(
                               "output[%3d] (%s %s, %s %s|%s %s, %s %s) = %f",
                               index, amv_a_bar.debugOut().c_str(),
...
void DfEriEngine::transform6Dto5D(const AngularMomentum2& qAB,
  ...
  std::cerr << TlUtils::format(
                   "DfEriEngine::transform6Dto5D() in: a=%d, b=%d, c=%d, d=%d",
                   a, b, c, d)
            << std::endl;
        ...
        for (int l_ = 0; l_ < L_; ++l_) {
          for (int j = 0; j < J; ++j) {
            for (int k = 0; k < K; ++k) {
              for (int l = 0; l < L; ++l) {
                const double xx =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 6 + 0) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double xy =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 6 + 1) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double xz =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 6 + 2) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double yy =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 6 + 3) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double yz =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 6 + 4) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double zz =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 6 + 5) *
                                 J +
                             j) *
                                K +
                            k) *
        ...
        for (int l_ = 0; l_ < L_; ++l_) {
          for (int i = 0; i < I; ++i) {
            for (int k = 0; k < K; ++k) {
              for (int l = 0; l < L; ++l) {
                const double xx =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * I + i) *
                                 6 +
                             0) *
                                K +
                            k) *
        ...
        for (int l_ = 0; l_ < L_; ++l_) {
          for (int j = 0; j < J; ++j) {
            for (int k = 0; k < K; ++k) {
              for (int l = 0; l < L; ++l) {
                const double xxx =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 0) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double xxy =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 1) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double xxz =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 2) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double xyy =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 3) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double xyz =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 4) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double xzz =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 5) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double yyy =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 6) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double yyz =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 7) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double yzz =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 8) *
                                 J +
                             j) *
                                K +
                            k) *
                           ...
                           l];
                const double zzz =
                    pInput[((((((i_ * J_ + j_) * K_ + k_) * L_ + l_) * 10 + 9) *
                                 J +
                             j) *
                                K +
                            k) *
  ...
  for (int i = 0; i < maxSize; ++i) {
...
#ifdef DEBUG_CHECK_WORK_D
    {
      ...
      if (std::fabs(diff) > 1.0E-5) {
        this->log_.debug(
            TlUtils::format("DfEriEngine::compD(): wrong D' value %4d-th "
...
void DfEriEngine::calc(const AngularMomentum2& qAB,
                       const AngularMomentum2& qCD) {
  // this->log_.debug(TlUtils::format("DfEriEngine::calc(): a~=%d, b~=%d, a=%d,
  // b=%d,",
  //                                  qAB.a_bar, qAB.b_bar, qAB.a, qAB.b));
  // this->log_.debug(TlUtils::format("                     c~=%d, d~=%d, c=%d,
  // d=%d,",
        ...
        for (int index_a = 0; index_a < amvs_a.size(); ++index_a) {
          ...
          for (int index_b = 0; index_b < amvs_b.size(); ++index_b) {
            ...
            const std::string str = TlUtils::format(
                ...
                amv_a_bar.debugOut().c_str(), amv_b_bar.debugOut().c_str(),
                amv_a.debugOut().c_str(), amv_b.debugOut().c_str(),
                amv_p.debugOut().c_str(), a_prime, b_prime, p_prime);
            const std::vector<double> values = eri[bra_state][bra_index];
            for (int i = 0; i < values.size(); ++i) {
              std::cerr << TlUtils::format("%s [%3d] = % f", str.c_str(), i,
                                           values[i])
                        << std::endl;
            }
          }
...
void DfEriEngine::calcGrad(const AngularMomentum2& qAB,
  ...
  // contract
  this->contract(qAB10, qCD00, bra_contractScales_vtr, ket_contractScales_vtr);

  // A ----------------------------------------------------
  {
    // calc PQ
    this->calcPQ(qAB10, qCD00, bra_contractScales_vtr, ket_contractScales_vtr);
  ...
  {
    // // calc PQ
    this->calcPQ(qAB01, qCD00, bra_contractScales_vtr, ket_contractScales_vtr);
  ...
  // for debug
  {
    ...
    for (int m = 0; m <= M; ++m) {
      ...
      for (int i = 0; i < KPKQ; ++i) {
        std::cerr << TlUtils::format("calcR0(in): [0](%d) [%d] = %f", m, i,
                                     this->pRM_[index][i])
                  << std::endl;
      }
    }
...
DfEriEngine::ContractScalesVector DfEriEngine::choice(
  ...
  if (this->choice_tbl_.find(index) == this->choice_tbl_.end()) {
    ...
    this->choice(qAB.a_bar, qAB.b_bar, qAB.a, qAB.b, 0, 0, 0, 0, &contractList);
...
void DfEriEngine::choice(const int a_bar, const int b_bar, const int a,
  ...
  if ((a_bar == 0) && (b_bar == 0) && (a == 0) && (b == 0)) {
    ...
    // use eq.43
    this->choice(a_bar - 1, b_bar, a + 1, b, p, a_prime + 1, b_prime, p_prime,
                 pContractList);
    this->choice(a_bar - 1, b_bar, a - 1, b, p, a_prime, b_prime, p_prime,
                 pContractList);
    this->choice(a_bar - 1, b_bar, a, b, p - 1, a_prime + 1, b_prime, p_prime,
                 pContractList);
  } else if (b > 0) {
    // use eq.44
    ...
    this->choice(a_bar, b_bar, a - 1, b, p - 1, a_prime, b_prime, p_prime,
                 pContractList);
    this->choice(a_bar, b_bar, a - 1, b, p + 1, a_prime, b_prime, p_prime + 1,
                 pContractList);
    this->choice(a_bar, b_bar, a - 1, b, p, a_prime, b_prime + 1, p_prime + 1,
                 pContractList);
...
DfEriEngine::ContractScalesVector DfEriEngine::transContractScales_SetToVector(
  ...
  for (ContractScalesSet::const_iterator p = contractScales.begin(); p != pEnd;
       ++p) {
    answer[index] = *p;
    ++index;
  }
...
void DfEriEngine::contract(const AngularMomentum2& qAB,
  ...
  for (int bra_cs_index = 0; bra_cs_index < max_bra_cs_index; ++bra_cs_index) {
    ...
    for (int r = 0; r <= R; ++r) {
      //             std::cerr << TlUtils::format("contract() for bra- a'=%d
      //             b'=%d p'=%d r=%d",
      //                                          a_prime, b_prime, p_prime, r)
      //                                          << std::endl;
...
void DfEriEngine::contract_bra(const AngularMomentum2& qAB,
  ...
  for (int i = 0; i < tmp.size(); ++i) {
    std::cerr << TlUtils::format("(R') %s [%d] = % f", cs.debugOut().c_str(), i,
                                 values[i])
              << std::endl;
  }
#endif  // DEBUG_CONTRACT_BRA
...
void DfEriEngine::calcPQ(const AngularMomentum2& qAB,
  ...
  // ContractState cs;
  const std::vector<int> cs_indeces =
      this->get_csindex_for_calcPQ(angularMomentumP, qAB, angularMomentumQ, qCD,
                                   bra_contractScales, ket_contractScales);
        ...
        for (int ket_cs_index = 0; ket_cs_index < max_ket_cs_index;
          ...
          for (int q = 0; q <= angularMomentumQ; ++q) {
            ...
            for (int j = 0; j < numOf_amvs_q; ++j) {
              ...
              // for debug
              std::cerr << TlUtils::format(
                               "calcPQ: %s(p=%s) [ket:%d] = (R'') (%s: %d %d "
                               "%d|%d %d %d)=% f*% f",
                               bra_state.debugOut().c_str(),
                               amv_p.debugOut().c_str(), ket_index,
                               r.debugOut().c_str(), a_prime, b_prime, p_prime,
                               c_prime, d_prime, q_prime, value, coef)
                        << std::endl;
#endif  // DEBUG_CALC_PQ
...
std::vector<int> DfEriEngine::get_csindex_for_calcPQ(
  ...
  //     qAB.index())*ERI_P_MAX + angularMomentumQ)*AngularMomentum2::maxIndex()
  //     + qCD.index();
...
void DfEriEngine::transpose(const AngularMomentum2& qAB,
...
#ifdef DEBUG_HGP
  std::cerr << "DfEriEngine::transpose(): angularMomentumQ=" << angularMomentumQ
            << std::endl;
#endif  // DEBUG_HGP
  ...
  // for (ContractScalesVector::const_iterator it_ket =
  // ket_contractScales.begin(); it_ket != it_ket_end; ++it_ket) {
  const int max_ket_cs_index = ket_contractScales.size();
  for (int ket_cs_index = 0; ket_cs_index < max_ket_cs_index; ++ket_cs_index) {
    const int c_prime = ket_contractScales[ket_cs_index].a_prime;
    const int d_prime = ket_contractScales[ket_cs_index].b_prime;
...
void DfEriEngine::calcERI(const int a_bar, const int b_bar, const int a,
  ...
  if (this->isCalcdERI_[eriState.index()] == 0) {
    ...
    if (b_bar > 0) {
      // use eq.47
      this->calcERI(a_bar, b_bar - 1, a, b, p + 1, a_prime, b_prime, p_prime,
                    pERI);
      this->calcERI(a_bar + 1, b_bar - 1, a, b, p, a_prime, b_prime, p_prime,
                    pERI);
      this->calcERI(a_bar, b_bar - 1, a - 1, b, p, a_prime, b_prime, p_prime,
                    pERI);
      this->calcERI(a_bar, b_bar - 1, a, b - 1, p, a_prime, b_prime, p_prime,
                    pERI);
      ...
      this->calcERI(a_bar - 1, b_bar, a + 1, b, p, a_prime + 1, b_prime,
                    p_prime, pERI);
      this->calcERI(a_bar - 1, b_bar, a - 1, b, p, a_prime, b_prime, p_prime,
                    pERI);
      ...
      // use eq.44
      this->calcERI(a_bar, b_bar, a + 1, b - 1, p, a_prime, b_prime, p_prime,
                    pERI);
      this->calcERI(a_bar, b_bar, a, b - 1, p, a_prime, b_prime, p_prime, pERI);
      this->calcERI(a_bar - 1, b_bar, a, b - 1, p, a_prime, b_prime, p_prime,
                    pERI);
      this->calcERI(a_bar, b_bar - 1, a, b - 1, p, a_prime, b_prime, p_prime,
                    pERI);
      ...
      // use eq.45
      this->calcERI(a_bar, b_bar, a - 1, b, p - 1, a_prime, b_prime, p_prime,
                    pERI);
      ...
      for (int amv_b_bar_index = 0; amv_b_bar_index < numOfAmv_b_bar;
        ...
        for (int amv_a_index = 0; amv_a_index < numOfAmv_a; ++amv_a_index) {
          ...
          for (int amv_p_index = 0; amv_p_index < numOfAmv_p; ++amv_p_index) {
            ...
            // batch -----------------------------------------------
            const ERI_State eriState1(a_bar, b_bar, a + 1, b - 1, p, a_prime,
                                      b_prime, p_prime);
            const int eriState1_index = eriState1.index();
            const int index1 =
                this->index(amv_a_bar, amv_b_bar, amv_a1p, amv_b1, amv_p);

            const ERI_State eriState2(a_bar, b_bar, a, b - 1, p, a_prime,
                                      b_prime, p_prime);
            ...
            if (amv_a_bar1.isExist() == true) {
              const ERI_State eriState3(a_bar - 1, b_bar, a, b - 1, p, a_prime,
                                        b_prime, p_prime);
              eriState3_index = eriState3.index();
              index3 = this->index(amv_a_bar1, amv_b_bar, amv_a, amv_b1, amv_p);
            }

            int eriState4_index = 0;
            int index4 = 0;
            if (amv_b_bar1.isExist() == true) {
              const ERI_State eriState4(a_bar, b_bar - 1, a, b - 1, p, a_prime,
                                        b_prime, p_prime);
              eriState4_index = eriState4.index();
              index4 = this->index(amv_a_bar, amv_b_bar1, amv_a, amv_b1, amv_p);
            }
        ...
        // answer -= this->AB_[i] * value2;
              ...
              if (amv_a_bar1.isExist() == true) {
                answer +=
                    amv_a_bar.get(i) * (*pERI)[eriState3_index][index3][batch];
              }

              // 4th term
              if (amv_b_bar1.isExist() == true) {
                answer -=
                    amv_b_bar.get(i) * (*pERI)[eriState4_index][index4][batch];
              }
    ...
    for (int amv_a_bar_index = 0; amv_a_bar_index < numOfAmv_a_bar;
      ...
      for (int amv_b_bar_index = 0; amv_b_bar_index < numOfAmv_b_bar;
        ...
        for (int amv_b_index = 0; amv_b_index < numOfAmv_b; ++amv_b_index) {
          ...
          for (int amv_p_index = 0; amv_p_index < numOfAmv_p; ++amv_p_index) {
            ...
            if (amv_p1.isExist() == true) {
              const ERI_State eriState1(a_bar, b_bar, a - 1, b, p - 1, a_prime,
                                        b_prime, p_prime);
              eriState1_index = eriState1.index();
              index1 = this->index(amv_a_bar, amv_b_bar, amv_a1, amv_b, amv_p1);
            }
            const double p_i = amv_p.get(i);

            const ERI_State eriState2(a_bar, b_bar, a - 1, b, p + 1, a_prime,
                                      b_prime, p_prime + 1);
            const int eriState2_index = eriState2.index();
            const int index2 =
                this->index(amv_a_bar, amv_b_bar, amv_a1, amv_b, amv_p1p);

            const ERI_State eriState3(a_bar, b_bar, a - 1, b, p, a_prime,
                                      b_prime + 1, p_prime + 1);
            ...
            int index4 = 0;
            if (amv_a_bar1.isExist() == true) {
              const ERI_State eriState4(a_bar - 1, b_bar, a - 1, b, p, a_prime,
                                        b_prime + 1, p_prime + 1);
              eriState4_index = eriState4.index();
              index4 = this->index(amv_a_bar1, amv_b_bar, amv_a1, amv_b, amv_p);
            }

            int eriState5_index = 0;
            int index5 = 0;
            if (amv_b_bar1.isExist() == true) {
              const ERI_State eriState5(a_bar, b_bar - 1, a - 1, b, p, a_prime,
                                        b_prime + 1, p_prime + 1);
              eriState5_index = eriState5.index();
              index5 = this->index(amv_a_bar, amv_b_bar1, amv_a1, amv_b, amv_p);
            }
...
#ifdef DEBUG_EQ45
                std::cerr << TlUtils::format(
                                 "EQ45(1st): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
                                 amv_a_bar.debugOut().c_str(),
                                 amv_b_bar.debugOut().c_str(),
                                 amv_a1.debugOut().c_str(),
                                 amv_b.debugOut().c_str(),
                                 amv_p1.debugOut().c_str(), a_prime, b_prime,
                                 p_prime, batch, value1)
                          << std::endl;
#endif  // DEBUG_EQ45
                answer += p_i * value1;
...
#ifdef DEBUG_EQ45
                std::cerr << TlUtils::format(
                                 "EQ45(2nd): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
                                 amv_a_bar.debugOut().c_str(),
                                 amv_b_bar.debugOut().c_str(),
                                 amv_a1.debugOut().c_str(),
                                 amv_b.debugOut().c_str(),
                                 amv_p1p.debugOut().c_str(), a_prime, b_prime,
                                 p_prime + 1, batch, value2)
                          << std::endl;
#endif  // DEBUG_EQ45
                answer += value2;
              }
...
#ifdef DEBUG_EQ45
                std::cerr << TlUtils::format(
                                 "EQ45(3rd): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
                                 amv_a_bar.debugOut().c_str(),
                                 amv_b_bar.debugOut().c_str(),
                                 amv_a1.debugOut().c_str(),
                                 amv_b.debugOut().c_str(),
                                 amv_p.debugOut().c_str(), a_prime, b_prime + 1,
        ...
        // answer += this->AB_[i] * value3;
              ...
              if (amv_a_bar1.isExist() == true) {
                answer -=
                    amv_a_bar.get(i) * (*pERI)[eriState4_index][index4][batch];
              }

              // 5th term
              if (amv_b_bar1.isExist() == true) {
                answer +=
                    amv_b_bar.get(i) * (*pERI)[eriState5_index][index5][batch];
              }
...
void DfEriEngine::ERI_EQ45_00x0x(const ERI_State eriState, EriDataType* pERI) {
  ...
  for (int amv_a_index = 0; amv_a_index < numOfAmv_a; ++amv_a_index) {
    ...
    for (int amv_p_index = 0; amv_p_index < numOfAmv_p; ++amv_p_index) {
      ...
      const int index = this->index(amv_a_bar, amv_b_bar, amv_a, amv_b, amv_p);
      (*pERI)[stateIndex][index].resize(ERI_MAX_BATCH);
...
void DfEriEngine::ERI_EQ45_00x00(const ERI_State eriState, EriDataType* pERI) {
  ...
  for (int amv_a_index = 0; amv_a_index < numOfAmv_a; ++amv_a_index) {
    ...
    const int index2 =
        this->index(amv_a_bar, amv_b_bar, amv_a1, amv_b, amv_p1p);
    const int index3 = this->index(amv_a_bar, amv_b_bar, amv_a1, amv_b, amv_p);
          ...
          for (int amv_p_index = 0; amv_p_index < numOfAmv_p; ++amv_p_index) {
            ...
            for (int batch = 0; batch < batchSize; ++batch) {
              ...
              // 1st term
              {
                ...
                const int index1 =
                    this->index(amv_a_bar1, amv_b_bar, amv_a, amv_b, amv_p1p);
                // const double value1 = (*pERI)[eriState1][index1][batch];
                const double value1 = (*pERI)[eriState1.index()][index1][batch];
#ifdef DEBUG_EQ46
                std::cerr << TlUtils::format(
                                 "EQ46(1st): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
                                 amv_a_bar1.debugOut().c_str(),
                                 amv_b_bar.debugOut().c_str(),
                                 amv_a.debugOut().c_str(),
                                 amv_b.debugOut().c_str(),
                                 amv_p1p.debugOut().c_str(), a_prime + 1,
                                 b_prime, p_prime + 1, batch, value1)
                          << std::endl;
#endif  // DEBUG_EQ46
                answer += value1;
              }
              ...
              // 3rd term
              {
                const ERI_State eriState3(a_bar - 1, b_bar, a, b, p,
                                          ...
                                          p_prime + 1);
                const int index3 =
                    this->index(amv_a_bar1, amv_b_bar, amv_a, amv_b, amv_p);
                // const double value3 = (*pERI)[eriState3][index3][batch];
                const double value3 = (*pERI)[eriState3.index()][index3][batch];
#ifdef DEBUG_EQ46
                std::cerr << TlUtils::format(
                                 "EQ46(3rd): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
                                 amv_a_bar1.debugOut().c_str(),
                                 amv_b_bar.debugOut().c_str(),
                                 amv_a.debugOut().c_str(),
                                 amv_b.debugOut().c_str(),
                                 amv_p.debugOut().c_str(), a_prime + 1,
                                 b_prime + 1, p_prime + 1, batch, value3)
                          << std::endl;
#endif  // DEBUG_EQ46
                answer += this->AB_[i] * value3;
              }
              ...
              if (amv_a_bar2.isExist() == true) {
                const ERI_State eriState4(a_bar - 2, b_bar, a, b, p,
                                          ...
                                          p_prime + 1);
                const int index4 =
                    this->index(amv_a_bar2, amv_b_bar, amv_a, amv_b, amv_p);
              ...
              if (amv_b_bar1.isExist() == true) {
                const ERI_State eriState5(a_bar - 1, b_bar - 1, a, b, p,
                                          ...
                                          p_prime + 1);
                const int index5 =
                    this->index(amv_a_bar1, amv_b_bar1, amv_a, amv_b, amv_p);
          ...
          for (int amv_p_index = 0; amv_p_index < numOfAmv_p; ++amv_p_index) {
            ...
            for (int batch = 0; batch < batchSize; ++batch) {
              ...
              // 1st term
              {
                ...
                const int index1 =
                    this->index(amv_a_bar1, amv_b_bar, amv_a1p, amv_b, amv_p);
                // const double value1 = (*pERI)[eriState1][index1][batch];
                const double value1 = (*pERI)[eriState1.index()][index1][batch];
#ifdef DEBUG_EQ43
                std::cerr << TlUtils::format(
                                 "EQ43(1st): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
                                 amv_a_bar1.debugOut().c_str(),
                                 amv_b_bar.debugOut().c_str(),
                                 amv_a1p.debugOut().c_str(),
                                 amv_b.debugOut().c_str(),
                                 amv_p.debugOut().c_str(), a_prime + 1, b_prime,
                                 p_prime, batch, value1)
                          << std::endl;
#endif  // DEBUG_EQ43
                answer += value1;
              ...
              if (amv_p1.isExist() == true) {
                const ERI_State eriState3(a_bar - 1, b_bar, a, b, p - 1,
                                          a_prime + 1, b_prime, p_prime);
                const int index3 =
                    this->index(amv_a_bar1, amv_b_bar, amv_a, amv_b, amv_p1);
                // const double value3 = (*pERI)[eriState3][index3][batch];
                const double value3 = (*pERI)[eriState3.index()][index3][batch];
#ifdef DEBUG_EQ43
                std::cerr << TlUtils::format(
                                 "EQ43(3rd): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
                                 amv_a_bar1.debugOut().c_str(),
                                 amv_b_bar.debugOut().c_str(),
                                 amv_a.debugOut().c_str(),
            ...
            for (int batch = 0; batch < batchSize; ++batch) {
              ...
              // 1st term
              {
                ...
                const ERI_State eriState1(a_bar, b_bar - 1, a, b, p + 1,
                                          a_prime, b_prime, p_prime);
                const int index1 =
                    this->index(amv_a_bar, amv_b_bar1, amv_a, amv_b, amv_p1p);
                const double value1 = (*pERI)[eriState1.index()][index1][batch];
#ifdef DEBUG_EQ47
                std::cerr << TlUtils::format(
                                 "EQ47(1st): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
                                 amv_a_bar.debugOut().c_str(),
                  ...
                  amv_a_bar + this->E1_[i];
              {
                const ERI_State eriState2(a_bar + 1, b_bar - 1, a, b, p,
                                          a_prime, b_prime, p_prime);
                const int index2 =
                    this->index(amv_a_bar1p, amv_b_bar1, amv_a, amv_b, amv_p);
                const double value2 = (*pERI)[eriState2.index()][index2][batch];
#ifdef DEBUG_EQ47
                std::cerr << TlUtils::format(
                                 "EQ47(2nd): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
              ...
              if (amv_a1.isExist() == true) {
                const ERI_State eriState3(a_bar, b_bar - 1, a - 1, b, p,
                                          a_prime, b_prime, p_prime);
                const int index3 =
                    this->index(amv_a_bar, amv_b_bar1, amv_a1, amv_b, amv_p);
                const double value3 = (*pERI)[eriState3.index()][index3][batch];
#ifdef DEBUG_EQ47
                std::cerr << TlUtils::format(
                                 "EQ47(3rd): (%s %s, %s %s %s, %d %d %d| "
                                 "batch[%d] = % f",
                                 amv_a_bar.debugOut().c_str(),
                                 amv_b_bar1.debugOut().c_str(),
                                 amv_a1.debugOut().c_str(),
              ...
              if (amv_b1.isExist() == true) {
                const ERI_State eriState4(a_bar, b_bar - 1, a, b - 1, p,
                                          a_prime, b_prime, p_prime);
                const int index4 =
                    this->index(amv_a_bar, amv_b_bar1, amv_a, amv_b1, amv_p);
                // answer -= amv_b.get(i) * (*pERI)[eriState4][index4][batch];
                answer -=
                    amv_b.get(i) * (*pERI)[eriState4.index()][index4][batch];
              }
