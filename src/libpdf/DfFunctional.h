...
class DfFunctional_GGA {
   ...
   public:
    ...
    void getDerivativeFunctional(double dRhoA, double dGammaAA,
        ...
        this->getDerivativeFunctional(
            dRhoA, dRhoA, dGammaAA, dGammaAA, dGammaAA, pRoundF_roundRhoA,
            &dRoundF_roundRhoB, pRoundF_roundGammaAA, pRoundF_roundGammaAB,
   ...
   public:
    ...
    virtual TlDenseGeneralMatrix_Lapack getDerivativeFunctionalCore(
        const double rhoA, const double rhoB, const double xA,
        const double xB) {
        return TlDenseGeneralMatrix_Lapack();
    }
