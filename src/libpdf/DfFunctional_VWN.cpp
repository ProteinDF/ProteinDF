...
void DfFunctional_VWN::roundVWN_roundRho(const double dRhoA, const double dRhoB,
  ...
  *pRoundF_roundRhoB = 0.0;
  ...
  const double h_prime =
      this->h_prime(dEc_p, dEc_f, dEc_a, dEc_p_prime, dEc_f_prime, dEc_a_prime);
  ...
  // const double term2coef = dEc_a * (g_prime * (1.0 + h * zeta) + 4.0 * g * h
  // * zeta);
...
void DfFunctional_VWN::roundVWN_roundRho(const double dRhoA,
  ...
  *pRoundF_roundRhoA = 0.0;
  ...
  // const double term2coef = dEc_a * (g_prime * (1.0 + h * zeta4) + 4.0 * g * h
  // * zeta3); // =0 when RKS.
