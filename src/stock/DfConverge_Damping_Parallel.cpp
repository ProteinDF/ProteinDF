    ...
    switch (this->m_nMethodType) {
        ...
        default:
            std::cerr << "program error. "
                         "@DfConverge_Damping_Parallel::convergeRhoTilde()"
                      << std::endl;
            break;
    }
}
...
void DfConverge_Damping_Parallel::convergeKSMatrix_ScaLAPACK() {
    switch (this->m_nMethodType) {
        case METHOD_RKS:
            DfConverge_Damping::convergeKSMatrix<
                TlDenseSymmetricMatrix_Scalapack>(DfObject::RUN_RKS);
            break;
        case METHOD_UKS:
            DfConverge_Damping::convergeKSMatrix<
                TlDenseSymmetricMatrix_Scalapack>(DfObject::RUN_UKS_ALPHA);
            DfConverge_Damping::convergeKSMatrix<
                TlDenseSymmetricMatrix_Scalapack>(DfObject::RUN_UKS_BETA);
            break;
        case METHOD_ROKS:
            DfConverge_Damping::convergeKSMatrix<
                TlDenseSymmetricMatrix_Scalapack>(DfObject::RUN_UKS_ALPHA);
        ...
        default:
            std::cerr << "program error. "
                         "@DfConverge_Damping_Parallel::convergeKSMatrix()"
                      << std::endl;
            break;
    }
}
...
void DfConverge_Damping_Parallel::convergePMatrix_ScaLAPACK() {
    switch (this->m_nMethodType) {
        ...
        default:
            std::cerr << "program error. "
                         "@DfConverge_Damping_Distribute::convergePMatrix()"
                      << std::endl;
            break;
    }
}
