...
public:
    ...
    TlSerializeDataVectorIterator(const TlSerializeDataVectorIterator& rhs) : it_(rhs.it_) {
    }

    ~TlSerializeDataVectorIterator() {
    }

    TlSerializeDataVectorIterator& operator=(const TlSerializeDataVectorIterator& rhs) {
        if (&rhs != this) {
            this->it_ = rhs.it_;
        }
    }
...
public:
    ...
    TlSerializeDataVectorConstIterator(const TlSerializeDataVectorConstIterator& rhs) : it_(rhs.it_) {
    }

    ~TlSerializeDataVectorConstIterator() {
    }

    TlSerializeDataVectorConstIterator& operator=(const TlSerializeDataVectorConstIterator& rhs) {
        if (&rhs != this) {
            this->it_ = rhs.it_;
        }
    }
...
public:
    ...
    TlSerializeDataMapIterator(const TlSerializeDataMapIterator& rhs) : it_(rhs.it_) {
    }
...
public:
    ...
    TlSerializeDataMapConstIterator(const TlSerializeDataMapConstIterator& rhs) : it_(rhs.it_) {
    }
    
    ~TlSerializeDataMapConstIterator() {
    }

    TlSerializeDataMapConstIterator& operator=(const TlSerializeDataMapConstIterator& rhs) {
        if (&rhs != this) {
            this->it_ = rhs.it_;
        }
    }
